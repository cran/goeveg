...
#'     \item \code{"niwap" }- Scale used by Lower Saxony species survey programs (Schacherer 2001). Own conversion as approximation based on a/b-values, which are based on individual counts. Needs to be adapted to sample sizes. 
...
#'
#' Schacherer, A. (2001): Das Niedersächsische Pflanzenartenerfassungsprogramm. Herausgegeben vom Niedersächsischen Landesamt für Ökologie - Fachbehörde für Naturschutz. 
#' \emph{Informationsdienst Naturschutz Niedersachsen}, \strong{21(5 - Supplement Pflanzen)}: 1–20.
#'
#' @name scale_tabs
#' @docType data
#' @keywords datasets
